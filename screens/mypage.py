...
class MyPageScreen(Screen):
    ...
    def _build_quick_actions(self):
        ...
        items = [
            ("通知", "icon_bell.png", self._show_notification_popup),
            ("二维码", "icon_qr.png", self._show_qrcode_popup),
            ("拍照", "icon_camera.png", lambda *_: App.get_running_app().show_capture_menu()),
            ("通讯录", "icon_contact.png", self._show_contact_popup),
        ]
    ...
    def _update_layout(self, *_args):
        ...
        available = max(dp(240), self.height - nav_h - top_h + dp(20))
